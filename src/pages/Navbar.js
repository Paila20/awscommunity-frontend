...
const Navbar = () => {
  ...
  return (
    <nav className={`navbar navbar-expand-lg px-lg-5  ${isToggled ? "mobile-navbar1" : "header-top"}`}>
      <div className="container-fluid  mx-lg-5 px-lg-5 text-white">
        <p className="fs-4 cursor-pointer hover:text-purple-500 transition-colors duration-300" >
          <img src={logo} alt="logo" className="w-50" />
        </p>

        <button className="d-lg-none mb-2 bg-transparent text-white border-0" type="button"
        ...
        <div className={`collapse navbar-collapse h-100 ${isToggled ? "show" : ""}`} id="navbarNav">
